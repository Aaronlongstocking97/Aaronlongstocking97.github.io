...
FROM (SELECT COUNT(*) AS rental_count
  FROM rental) il1 CROSS JOIN
        (SELECT COUNT(*) AS rental_item_count
  FROM rental_item) il2 CROSS JOIN
        (SELECT COUNT(*) AS transaction_count
  FROM TRANSACTION) il3;
...
--
COLUMN month               FORMAT 99,999 HEADING "MONTH"
COLUMN base_revenue        FROMAT 99,999 HEADING "BASE_REVENUE"
COLUMN ten_plus            FORMAT 99,999 HEADING "10_PLUS"
COLUMN twenty_plus         FORMAT 99,999 HEADING "20_PLUS"
COLUMN ten_plus_less_b     FORMAT 99,999 HEADING "10_PLUS_LESS_B"
COLUMN twenty_plus_less_b  FORMAT 99,999 HEADING "20_PLUS_LESS_B"
...
, TO_CHAR(SUM(transaction_amount) * 0.10,'$9,999,999.00') AS ten_plus_less_b
, TO_CHAR(SUM(transaction_amount) * 0.20,'$9,999,999.00') AS twenty_plus_less_b
FROM transaction
WHERE EXTRACT(YEAR FROM TO_DATE(transaction_date)) = 2009
