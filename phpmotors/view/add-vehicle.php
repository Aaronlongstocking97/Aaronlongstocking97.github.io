    ...
    <div id="wrapper">
        ...
        <main id="main-content">
            ...
            <form action="/phpmotors/vehicles/index.php" id="align" method="post">
                ...
                <input type="text" id="make" name="vehicleMake" size="5">
                <label for="model">Model</label>
                <input type="text" id="model" name="vehicleModel" size="5">
                ...
                <input type="text" id="imgPath" name="vehicleImagePath" size="5">
                <label for="thumbPath">Thumbnail Path</label>
                <input type="text" id="thumbPath" name="vehicleThumbnailPath" size="5">
                <label for="price">Price</label>
                <input type="number" step="any" id="price" name="vehiclePrice" size="5">
                <label for="quantity"># In Stock</label>
                <input type="number" id="quantity" name="vehiclesInStock" size="5">
                <label for="color">Color</label>
                <input type="text" id="color" name="vehicleColor" size="5">
